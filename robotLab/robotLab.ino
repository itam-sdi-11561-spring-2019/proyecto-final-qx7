...
#define LOOP_DELTA 20 //ms loop time
#define LOOP_NAV 205 //ms vel loop
...
char hello[25] = "Saludos desde la chancla!";
...
void calcVel(){
  ...
  vel_R= counter_right*120.0/LOOP_DELTA;
  if(pwmLeft<0)
    vel_L= -1.0*vel_L;
  if (pwmRight<0)
    vel_R= -1.0*vel_R;
